...
export const PortfolioAnalysis: React.FC = () => {
  ...
  useEffect(() => {
    const checkFeatureAccess = async () => {
      if (featuresEnabled.portfolioAnalysis) {
        setIsFeatureReady(true);
        return;
      }

      try {
        await loadFeature('portfolioAnalysis');
        setIsFeatureReady(true);
      } catch (err) {
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Analyze crisis exposure and optimization opportunities</p>
          </div>
        </div>
        ...
        {isFeatureReady ? (
          ...
          <div className="flex items-center justify-center p-12">
            <div className="text-center">
              <h3 className="text-lg font-semibold mb-2">Loading Portfolio Analysis...</h3>
